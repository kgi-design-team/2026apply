...
const app = Vue.createApp({
    ...
    methods:{
        ...
        scrollMagic() {
            ...
            //     })
            // );
            TweenMax.from(".banner-tit", 0.7, {
                y: 200,
                opacity: 0,
            });
            TweenMax.from(".banner-sTit", 0.7, {
                opacity: 0,
                y: 200,
                delay: 0.2
            });
            TweenMax.from(".banner-content .btn", 0.7, {
                opacity: 0,
                y: 200,
                delay: 0.4
            });

            TweenMax.from(".banner-tattoo-1", 1, {
                opacity: 0,
                delay: 0.4
            });
            TweenMax.from(".banner-tattoo-2", 1, {
                opacity: 0,
                delay: 0.6
            });
        },
        ...
        fixedSignUpBtn() {
            const pos = $('.registrationForm').offset().top - (this.windowHeight / 2);
            $(window)
                .bind("scroll resize", function () {
                    var $this = $(this);
                    var $this_Top = $this.scrollTop();
                    ...
                    if ($this_Top > 100) {
                        $(".fixedSignUpBtn").stop().addClass('reduceSize');
                    }if ($this_Top < 100) {
                        $(".fixedSignUpBtn").stop().removeClass('reduceSize');
                    }
                })
                .scroll();
        },
